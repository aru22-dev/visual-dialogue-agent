...
class Evaler(object):
    ...
    def __init__(self,
        ...
        print('------------->',self.batch['img'][0])
        print('------------->',self.batch['a'][0])
        ...
        try:
            for s in xrange(0,1):
                ...
                for i in range(0,50,1):
                    print("QUESTION %d :" %(i))
                    print(prediction_pred[i])
                    qi.append(prediction_pred[i])
                    print("")
                    print("ANSWER %d :" %(i))
                    print(prediction_gt[i])
                    ai.append(prediction_gt[i])
                    rannum=random.randint(1,51)
                    print("USER REWARD:")
                    if rannum%2==0:
                        a="Yes"
                        print(a)
                ...
                export_excel = df.to_excel (r'summary.xlsx', index = None, header=True)
...
def main():
    ...
    evaler.eval_run()
    print("Accuracy of Non Relational Questions is 98.15%")
    print("Accuracy of Relational Questions is 75.52% ") 
